...
$my_orders_columns = apply_filters(
    ...
    'order-number'  => __('Pedido', 'understrap'),
    'order-date'    => __('Fecha', 'understrap'),
    'order-status'  => __('Estado', 'understrap'),
...
if ($customer_orders ) : ?>
    ...
    <h2><?php echo apply_filters('woocommerce_my_account_my_orders_title', __('Pedidos recientes', 'understrap')); ?></h2>
